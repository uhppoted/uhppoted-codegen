	...
	Tests: []RequestTest{
		{
			...
			Args: []TestArg{
				...
				TestArg{Arg: Arg{Name: "address", Type: "IPv4"}, Value: netip.MustParseAddr("192.168.1.125")},
				TestArg{Arg: Arg{Name: "netmask", Type: "IPv4"}, Value: netip.MustParseAddr("255.255.255.0")},
				TestArg{Arg: Arg{Name: "gateway", Type: "IPv4"}, Value: netip.MustParseAddr("192.168.1.1")},
			},
			Expected: []byte{
