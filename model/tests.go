...
var GetDoorTest = Test{
	Name: "get door",
	Request: &TestRequest{
		Name: GetDoorRequest.Name,
		Values: []Value{
			Value{
				Name:  "controller",
				Type:  "uint32",
...
var SetFirstCardTest = Test{
	Name: "set first-card",
	Request: &TestRequest{
		Name: SetFirstCardRequest.Name,
		Values: []Value{
			{
				Name:  "controller",
				Type:  "uint32",
	...
	Response: &TestResponse{
		Name: SetFirstCardResponse.Name,
		Values: []Value{
			Value{
				Name:  "controller",
				Type:  "uint32",
